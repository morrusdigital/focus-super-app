...
@section('title', 'Ubah Kategori BP')
...
@section('content')
  <div class="container-fluid">
    ...
    <form method="post" action="{{ route('budget-plan-categories.update', $category) }}">
      @csrf
      @method('put')
      <div class="card">
      ...
      <div class="card">
        <div class="card-body text-end">
          <a class="btn btn-light" href="{{ route('budget-plan-categories.show', $category) }}">Batal</a>
